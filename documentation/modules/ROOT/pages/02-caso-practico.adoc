...
[source,bash,subs="+macros,+attributes"]
----
[imagemode@workstation ~]$ ssh demouser@bastion.lab.example.com
[demouser@bastion ~]$ sudo su -
[root@bastion ~]# cd image-mode
[root@bastion ~]#  podman build -f Containerfile.rhel9.4 -t rhel-bootc-vm:v1 .
...
[root@bastion ~]# podman images
REPOSITORY                                    TAG         IMAGE ID      CREATED            SIZE
localhost/rhel-bootc-vm                       v1          cc3e1af1b6a6  2 minutes ago     1.75 GB
...
[root@bastion ~]# 
----
