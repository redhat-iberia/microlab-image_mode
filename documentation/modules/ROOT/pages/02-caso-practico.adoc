...
Desde el portátil, abre una pestaña del navegador y conectate a la máquina que acabas de https://imagemodetest.lab.melmac.univ[crear] para comprobar sí la aplicación funciona correctamente.
=====
