...
En nuestro ejemplo simplemente crearemos un contenedor que intala y configura un servidor apache para servir contenido mediante el protocolo HTTPS.
...
Abrimos una terminal y nos conectamos por ssh con el usuario **demouser** al host **bastion.lab.example.com** y creamos el contedor utilizando podman:

[.lines_7]
[.console-input]
[source,bash,subs="+macros,+attributes"]
----
$ ssh demouser@bastion.lab.example.com
$ sudo su -
# cd image-mode
image-mode # podman build -f Containerfile.rhel9.4 -t rhel-bootc-vm:v1 .
----
...
name = "demouser"
password = "redhat123"
key = "ssh-rsa  jadebustos@archimedes"
groups = ["wheel"]

image-mode # cat creating-vm.sh
#!/bin/bash
...
podman run --rm -it --privileged --pull=newer --security-opt label=type:unconfined_t \
           ...
           --type qcow2 --local registry.melmac.univ:5000/rhel-bootc-vm:v1
#
----
